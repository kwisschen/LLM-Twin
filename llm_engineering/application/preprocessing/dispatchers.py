...
class CleaningHandlerFactory:
    ...
    def create_handler(data_category: DataCategory) -> CleaningDataHandler:
        ...
        elif data_category == DataCategory.CONVERSATIONS:
            return ConversationCleaningHandler()
        else:
...
class CleaningDispatcher:
    ...
    @classmethod
    def dispatch(cls, data_model: NoSQLBaseDocument) -> VectorBaseDocument | None:
        ...
        try:
            ...
            logger.warning(f"Skipping document id={data_model.id} due to garbled content.")
            return None
...
class ChunkingHandlerFactory:
    ...
    def create_handler(data_category: DataCategory) -> ChunkingDataHandler:
        if data_category == DataCategory.POSTS:
            ...
            return ConversationChunkingHandler()
        else:
            raise ValueError("Unsupported data type")
...
class EmbeddingHandlerFactory:
    ...
    def create_handler(data_category: DataCategory) -> EmbeddingDataHandler:
        ...
        if data_category == DataCategory.POSTS:
            ...
            return ConversationEmbeddingHandler()
        else:
            raise ValueError("Unsupported data type")

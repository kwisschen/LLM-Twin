...
def fetch_all_data(user: UserDocument) -> dict[str, list[NoSQLBaseDocument]]:
    ...
    with ThreadPoolExecutor() as executor:
        future_to_query = {
            ...
            executor.submit(__fetch_conversations, user_id): "conversations",
        }
...
def __fetch_conversations(user_id) -> list[NoSQLBaseDocument]:
    return ConversationDocument.bulk_find(author_id=user_id)
